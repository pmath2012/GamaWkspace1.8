...
species stage{
	...
	aspect{
		draw square(8) at:location color:color;
...
species stage_director skills:[moving]{
	...
	reflex check_which_stage_to_close{
	...
	aspect{
		...
		draw geometry: 'Stage director' color:#black size:4 at:{location.x-4,location.y-2};
	}
}
species control_room{
	aspect{
		draw rectangle(10,4) at:location color:#orange;
		draw geometry: 'control room' color:#black size:4 at:{location.x-5,location.y-3};
	}
}
